...
from akbun_agent_analysiscode.commands.learn import run_learn
from akbun_agent_analysiscode.config import ServiceSource
from akbun_agent_analysiscode.knowledge import KnowledgeStore
...
def test_learn_all_failed_returns_error(two_service_config):
  ...
  assert not (two_service_config.knowledge_dir / "knowledge.db").exists()
