...
|---|---|
| [architecture.md](architecture.md) | The page and the split between DOM code and pure logic, the render loop, PNG export, the large view, storage |
