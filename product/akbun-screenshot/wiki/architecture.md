...
The toolbar has two number boxes, Size for text and badge glyphs and Line for stroke thickness, both in image pixels and both filled on load with the value that matches 24px and 3px on screen.
