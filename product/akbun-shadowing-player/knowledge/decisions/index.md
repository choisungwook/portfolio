...
* [릴리스 버전은 tag에서 마이너 +1로 자동 계산](2026-07-release-tag-auto-minor-bump.md) (대체됨)
* [릴리스 버전의 단일 출처를 package.json으로 되돌림](2026-07-version-source-package-json.md)
...
* [웹 배포는 renderer를 그대로 두고 window.api만 브라우저 구현으로 갈아 끼운다](2026-07-web-build-window-api-shim.md)
