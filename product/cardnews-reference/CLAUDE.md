# Card News Reference -- Agent Context

## 개요

AI agent가 카드뉴스(HTML)를 생성할 때 참조하는 레이아웃 레퍼런스 모음이다. Astro 정적 사이트로 빌드하여 Cloudflare Pages에 배포한다.

## 프로젝트 구조

```
product/cardnews-reference/
  public/layouts/    -- 6종 레이아웃 HTML (정적 파일로 서빙)
...
- 위치: `public/layouts/{type}.html`
- 카드 크기: 1080 x 1350px (4:5 비율)
