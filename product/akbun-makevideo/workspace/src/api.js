...
if (!window.__TAURI__) {
  ...
  window.api = {
    ...
    aiPreviewPlan: unavailable,
    aiApplyPlan: unavailable,
    aiLoadLibrary: async () => ({ templates: [], analyses: [] }),
    aiSaveLibrary: unavailable,
    aiSampleAsset: unavailable,
    aiAssetFingerprints: async () => ({}),
    aiCancelSampling: async () => {},
...
window.api = {
  ...
  aiPreviewPlan: (commands) => invoke('ai_preview_plan', { commands }),
  aiApplyPlan: (expected, revision, commands) => invoke('ai_apply_plan', { expected, revision, commands }),
  aiLoadLibrary: () => invoke('ai_load_library'),
  aiSaveLibrary: (library) => invoke('ai_save_library', { library }),
  aiSampleAsset: (assetId, startMs, endMs) => invoke('ai_sample_asset', { assetId, startMs, endMs }),
  aiAssetFingerprints: () => invoke('ai_asset_fingerprints'),
  aiCancelSampling: () => invoke('ai_cancel_sampling'),
