...
* 일반 대화에는 경로와 미디어가 없는 프로젝트 요약만 전달함
* 편집 스튜디오는 [편집 제안 경계](2026-09-astra-proposals-and-sampled-broll.md)에 따라 자막·타임라인과 선택한 B-roll 표본을 전달함
...
* 타임라인 편집은 모델 응답을 직접 실행하지 않고 Rust 검증과 사용자 검토를 거침
