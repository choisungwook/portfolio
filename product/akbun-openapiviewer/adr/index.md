...
* [Request snippets are generated from the schema, with placeholders left in](2026-08-request-snippets-from-the-schema.md) - Three template functions beat a snippet library that carries a dozen languages, and an invented path id would look runnable without being it.
