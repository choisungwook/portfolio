...
* [상단 탭 바를 headlamp 스타일 왼쪽 사이드메뉴로 바꾸고 테마를 CSS 변수로 옮긴다](2026-07-headlamp-sidebar-ui.md) - 배치만 사이드바로 바꾸고 색을 CSS 변수로 옮겨 dark mode를 함께 지원하되 renderer 로직은 그대로 두기로 한 결정.
