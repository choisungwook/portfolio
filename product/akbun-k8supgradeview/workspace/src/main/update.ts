 ...
 * 이 저장소의 release가 바이너리 저장소이고, tag는 akbun-k8supgradeview-v{버전} 형식이다.
 *
 ...
 * akbun-shadowing-player의 업데이트 구현과 같은 구조다.
 *
...
const TAG_PREFIX = "akbun-k8supgradeview-v";
...
const TEMP_PREFIX = "akbun-k8supgradeview-update-";
