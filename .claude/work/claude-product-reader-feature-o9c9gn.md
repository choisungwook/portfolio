...
- [ ] 4. product/akbun-wiki 생성: reader 동기화(raw markdown), graphify 빌드, SQLite 인덱스, API 키 인증, FastAPI
- [ ] 5. akbun-wiki wiki/adr/knowledge/README, verify workflow
- [ ] 6. product/README.md, 루트 README.md, products.json 갱신
