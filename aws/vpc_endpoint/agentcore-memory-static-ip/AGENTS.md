...
- STS 인증과 AgentCore Memory를 public NLB 고정 EIP로 호출하는 4개 시나리오의 핸즈온. S01 hosts 변경, S02 앱 네트워크 Squid forward proxy(DNS 변경 불가 시 권장), S05 자체 도메인 실패 확인, S07 AWS 안 CONNECT 프록시(비권장 참고용).
- 공통 규칙: @../../../AGENTS.md
...
- terraform/은 S01과 S05의 Route 53 레코드, terraform/labs/s07은 기존 VPC를 입력받는 독립 state.
