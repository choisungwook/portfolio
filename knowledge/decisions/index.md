...
* [LLM 백엔드는 모델 API가 아니라 agent 실행기 레벨에서 추상화한다](2026-08-agent-runner-level-backend.md) - akbun-agent-analysiscode가 LangGraph류 대신 Claude Agent SDK와 codex exec를 어댑터로 감싼 결정.
